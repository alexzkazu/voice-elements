...
Unfortunately, the [Web Speech API](https://dvcs.w3.org/hg/speech-api/raw-file/tip/speechapi.html) still has poor support. Check [Can I Use](http://caniuse.com/#feat=web-speech) for more information.
